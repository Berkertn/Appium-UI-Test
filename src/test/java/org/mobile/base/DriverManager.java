...
public class DriverManager {
    ...
    //TODO implement terminate and open active app
    public static void executeActivateApp(AppiumDriver appiumDriver, String bundleId) {
        appiumDriver.execute("activateApp", Map.of(ConfigReader.get("appPath"), bundleId));
    }

    public static void executeTerminateApp(AppiumDriver appiumDriver, String bundleId) {
        appiumDriver.execute("terminateApp", Map.of(ConfigReader.get("appPath"), bundleId));
    }
}
