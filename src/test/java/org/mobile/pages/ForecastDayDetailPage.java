...
public class ForecastDayDetailPage extends BasePage {
    ...
    By highestTempLocatorAnd = AppiumBy.xpath("//android.widget.TextView[@resource-id=\"com.accuweather.android:id/max_temperature\"]");
    ...
    public ForecastDayDetailPage() {
        ...
        locators.addLocator("highestTemperatureText", OS_TYPES.android, highestTempLocatorAnd);
